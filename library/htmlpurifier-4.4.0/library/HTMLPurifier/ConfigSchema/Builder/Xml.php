...
class HTMLPurifier_ConfigSchema_Builder_Xml extends XMLWriter
{
    ...
    public function buildDirective($directive) {
        ...
        if (!$this->namespace || $this->namespace !== $directive->keyValue->getRootNamespace()) {
            if ($this->namespace) $this->endElement(); // namespace
            $this->namespace = $directive->keyValue->getRootNamespace();
        ...
        $this->writeAttribute('id', $directive->keyValue->toString());

        $this->writeElement('name', $directive->keyValue->getDirective());
