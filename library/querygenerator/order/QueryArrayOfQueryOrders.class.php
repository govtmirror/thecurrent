...
/**
 * Description of QueryArrayOfQueryOrders
 *
 * @author Dan Kottke
 */
class QueryArrayOfQueryOrders extends ArrayOf implements IVerifiable, IOutputsToSQL, ITreeElement {
    ...
    public function isValidElement($value, $offset = null)
    {
        ...
        return ($value instanceof QueryOrder || $value instanceof self);
    }
