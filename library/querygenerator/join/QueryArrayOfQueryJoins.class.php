...
/**
 * Description of QueryArrayOfQueryJoins
 *
 * @author Dan Kottke
 */
class QueryArrayOfQueryJoins extends ArrayOf implements IVerifiable, IOutputsToSQL, ITreeElement{
    ...
    public function isValidElement($value, $offset = null)
    {
        ...
        return ($value instanceof QueryJoin || $value instanceof self);
    }
