...
/**
 * Description of QueryArrayOfSources
 *
 * @author Dan Kottke
 */
class QueryArrayOfSources extends ArrayOf implements IVerifiable, IOutputsToSQL, ITreeElement{
    ...
    public function isValidElement($value, $offset = null)
    {
        ...
        return ($value instanceof QuerySource || $value instanceof self || $value instanceof ISingleSourceValue);
    }
