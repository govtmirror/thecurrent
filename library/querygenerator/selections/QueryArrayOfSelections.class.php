...
/**
 * Description of QueryArrayOfSelections
 *
 * @author Dan Kottke
 */
class QueryArrayOfSelections extends ArrayOf implements IVerifiable, IOutputsToSQL, ITreeElement{
    ...
    public function isValidElement($value, $offset = null)
    {
        ...
        return ($value instanceof ISelectable || $value instanceof self || $value instanceof ISelectValue);
    }
