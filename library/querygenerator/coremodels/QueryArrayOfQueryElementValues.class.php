...
/**
 * Description of QueryArrayOfQueryElementValues
 *
 * @author Dan Kottke
 */
class QueryArrayOfQueryElementValues extends ArrayOf  implements IVerifiable, IOutputsToSQL, ITreeElement{
    ...
    public function isValidElement($value, $offset = null)
    {
        ...
        return ($value instanceof QueryElementValue || $value instanceof self);
    }
