...
if(!isset($TC_GenericRSSSource_SSSimplePie_CAS_widgetEntity_ID))
{
...
if(isset($TC_GenericRSSSource_SSSimplePie_CAS_widget))
{
    $model = $TC_GenericRSSSource_SSSimplePie_CAS_widget;
}
else
{
    $modelBuilder = new TC_GenericRSSSource_Builder($TC_GenericRSSSource_SSSimplePie_CAS_widgetEntity_ID);
...
<div class="widget">
    <h1><a target="_blank" href="<?php echo $feed->get_link() ;?>"><?php echo $model->get_title() ;?></a><div class="sourceExpandIcon opened"></div></h1>
              <ul id="widget-<?php echo $TC_GenericRSSSource_SSSimplePie_CAS_widgetEntity_ID ;?>" class="mediafeed">
            <?php 
                ...
                <a  class="feedInnerLink" href="javascript:void(0);" ><span><?php echo $purifier->purify($item->get_title()) ; ?></span>
                    ...
                    <div class="feedContent">
                        ...
                        <div class="feedContentMeta">
                            ...
                            {
                            ?>
                            <div style="float:right; padding-right:5px;"><a title="Discuss in Communities @ State" href="<?php echo $item->get_link() . '#comments' ;?>" target="_blank">comments:
                            <?php
