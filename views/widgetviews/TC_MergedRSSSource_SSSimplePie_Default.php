...
if(!isset($TC_MergedRSSSource_SSSimplePie_Default_widgetEntity_ID))
{
...
if(isset($TC_MergedRSSSource_SSSimplePie_Default_widget))
{
    $model = $TC_MergedRSSSource_SSSimplePie_Default_widget;
}
else
{
    $modelBuilder = new TC_MergedRSSSource_Builder($TC_MergedRSSSource_SSSimplePie_Default_widgetEntity_ID);
...
<div class="widget">
    <h1><?php echo $model->get_title() ;?><div class="sourceExpandIcon opened"></div></h1>
              <ul id="widget-<?php echo $TC_MergedRSSSource_SSSimplePie_Default_widgetEntity_ID ;?>" class="mediafeed">
            <?php 
